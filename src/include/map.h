...
enum __attribute__((__packed__)) TileIndices {
    ...
    TILEINDEX_HUMAN_SMITHY = 21,
    TILEINDEX_CONSTRUCTION_SMALL = 22,
    TILEINDEX_HUMAN_FARM = 23,
    TILEINDEX_HUMAN_BARRACKS = 24,
    TILEINDEX_HUMAN_LUMBERMILL = 28,
    TILEINDEX_HUMAN_CHURCH = 32,
    TILEINDEX_HUMAN_STABLES = 36,
    TILEINDEX_CONSTRUCTION_LARGE = 40,
    TILEINDEX_HUMAN_TOWNHALL = 44,
    TILEINDEX_HUMAN_MAGETOWER = 48,
};
