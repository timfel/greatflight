        ...
        for (int y = MAP_SIZE - 1; y >= 0; --y) {
            ...
            switch (tileIndex) {
                ...
                case 6: case 7: case 8: // trees
                    g_Map.m_ubPathmapXY[x * 2][y * 2] = MAP_FOREST_FLAG | MAP_UNWALKABLE_FLAG;
                    g_Map.m_ubPathmapXY[x * 2 + 1][y * 2] = MAP_FOREST_FLAG | MAP_UNWALKABLE_FLAG;
                    g_Map.m_ubPathmapXY[x * 2 + 1][y * 2 + 1] = MAP_FOREST_FLAG | MAP_UNWALKABLE_FLAG;
                    g_Map.m_ubPathmapXY[x * 2][y * 2 + 1] = MAP_FOREST_FLAG | MAP_UNWALKABLE_FLAG;
                    break;
                case 9: // water
                    g_Map.m_ubPathmapXY[x * 2][y * 2] = MAP_WATER_FLAG | MAP_UNWALKABLE_FLAG;
                    g_Map.m_ubPathmapXY[x * 2 + 1][y * 2] = MAP_WATER_FLAG | MAP_UNWALKABLE_FLAG;
                    g_Map.m_ubPathmapXY[x * 2 + 1][y * 2 + 1] = MAP_WATER_FLAG | MAP_UNWALKABLE_FLAG;
                    g_Map.m_ubPathmapXY[x * 2][y * 2 + 1] = MAP_WATER_FLAG | MAP_UNWALKABLE_FLAG;
                    break;
                case 10:
